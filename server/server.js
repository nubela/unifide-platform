...
(function() {
  ...
  new_user = function(user) {
    this.unblock();
    return Meteor.http.put("" + BACKEND_URL + "user/", {
      params: user
    });
  };

  new_inventory_container = function(container_id) {
    this.unblock();
    return Meteor.http.put("" + BACKEND_URL + "inventory/container/", {
      params: {
        container_id: container_id
      }
    });
