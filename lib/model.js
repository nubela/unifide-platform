...
PlopUser = new Meteor.Collection("plop_users");
...
ITEMTags = new Meteor.Collection("tag");
...
Cashback = new Meteor.Collection("cashbacks");
CreditStore = new Meteor.Collection("cashback_credit_store");
CreditLog = new Meteor.Collection("cashback_credit_log");
ShippingRule = new Meteor.Collection("shipping_rules");
TaxRule = new Meteor.Collection("tax_rules");
Order = new Meteor.Collection("orders");
Inventory = new Meteor.Collection("inventories");