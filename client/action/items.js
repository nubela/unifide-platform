...
(function() {
  var ITEM_RESERVED_KEYWORDS, ITEM_SORT_METHOD, ITEM_TEMPLATE, VIEW_TYPE, init_items, is_materialized_path_null, is_view_type, rehash_container_items, suburl_to_current_path_for_items, url_from_path;
    ...
    "click #delete-item": function() {
      return bootbox.confirm("Confirm delete?", function(res) {
        ...
        if (res) {
          item_id = Session.get(ITEM_SESSION.ITEM_ID);
          url = suburl_to_current_path_for_items();
          return Meteor.call("del_item", item_id, function(error, content) {
