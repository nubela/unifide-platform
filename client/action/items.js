...
(function() {
  var ITEM_RESERVED_KEYWORDS, ITEM_SORT_METHOD, ITEM_TEMPLATE, VIEW_TYPE, createItem, filterForSimilarItems, getItemTags, init_items, is_materialized_path_null, is_view_type, rehash_container_items, suburl_to_current_path_for_items, url_from_path;
  ...
  filterForSimilarItems = function(all_items) {
    ...
    var dic, filtered_items, i, k, picked_item, sorted_v, v, _i, _len;
    dic = {
      _legacy: []
    };
    for (_i = 0, _len = all_items.length; _i < _len; _i++) {
      i = all_items[_i];
      if (!"group_id" in i || (i.group_id == null)) {
        dic["_legacy"].push(i);
      } else {
        if (dic[i.group_id] == null) {
          dic[i.group_id] = [];
        }
  ...
  rehash_container_items = function() {
    ...
    return Meteor.subscribe("all_tags");
  };
  ...
  getItemTags = function(item_obj, item_id) {
    var t, tag_lis, tag_list, _i, _len, _ref;
    tag_lis = ITEMTags.find({
      $or: [
        {
