...
(function() {
  var ITEMS_PER_PAGE, createUser, getPage, getPageNo, getUpdateUser;
  ...
  Template.user_compose.rendered = function() {
    var grp, update_user, _i, _len, _ref, _results;
    update_user = getUpdateUser();
    if (update_user != null) {
      $("option[value=" + update_user.account_status + "]").attr("selected", true);
      _ref = update_user.groups;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        grp = _ref[_i];
        _results.push($("option[value=" + grp + "]").attr("selected", true));
      }
      return _results;
    }
  };
